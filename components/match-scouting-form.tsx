...
export function MatchForm({
  ...
  async function onSubmit(values: z.infer<typeof matchSchema>) {
    ...
    try {
      ...
      console.error(error);
      toast.error(
        error instanceof Error ? error.message : "Failed to update match data",
        { id: toastId },
      );
    }
          ...
          <div className="grid gap-4">
            <FormField
              ...
              render={({ field }) => (
                ...
                >
                  {field.value ? "Left Starting Zone ✓" : "Left Starting Zone"}
                </Button>
              )}
            />
            <FormField
              ...
              render={({ field }) => (
                <Button
                  ...
                  onClick={() => field.onChange(!field.value)}
                >
                  {field.value ? "Scored Points ✓" : "Scored Points"}
                </Button>
              )}
            />
          </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <Button
                  ...
                  onClick={() => field.onChange(!field.value)}
                >
                  {field.value ? "Human Player ✓" : "Human Player"}
                </Button>
              )}
            />
            <FormField
              ...
              render={({ field }) => (
                <Button
                  ...
                  onClick={() => field.onChange(!field.value)}
                >
                  {field.value ? "Ground Intake ✓" : "Ground Intake"}
                </Button>
              )}
            />
          </div>
